...
> **Section**: Infra  ·  **Subject ID**: `infra/shared`

**Primary package**: `@cat/shared`

## API Reference

| Symbol | Kind | Description |
| ------ | ---- | ----------- |
| `serializeAgentDefinition` | function | Serialize agent metadata and body content into a complete MD text. |
