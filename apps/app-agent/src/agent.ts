...
export const builtinAgentTemplates: readonly BuiltinAgentTemplate[] = [
  ...
  },
  {
    ...
    definition: {
      ...
      systemPrompt: [
        "Complete the partial translation after the cursor.",
        "Source: {{sourceText}}",
      ...
      systemPromptVariables: {
        ...
        prefix: {
          ...
          source: "context",
          name: "Prefix",
          description: "Text that has already been typed before the cursor",
        },
        suffix: {
          type: "string",
          source: "context",
          name: "Suffix",
          description: "Text that comes after the cursor",
        },
      },
      tools: [],
      constraints: {
