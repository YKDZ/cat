// oxlint-disable typescript/no-unsafe-return, typescript/no-unsafe-type-assertion -- Vue Flow exposes a much wider runtime prop contract than this component reads.
import { mount } from "@vue/test-utils";
import { describe, expect, it, vi } from "vitest";

import DagNode from "#/components/dag-graph/DagNode.vue";
import type { DagNodeData } from "#/components/dag-graph/types.ts";
