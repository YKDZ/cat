...
export const KanbanCardSchema = z.object({
  ...
  linkedResourceType: z.string().nullable(),
  linkedResourceId: z.string().nullable(),
  status: z.enum(["OPEN", "CLAIMED", "IN_PROGRESS", "REVIEW", "DONE", "FAILED", "NEEDS_REWORK"]),
...
export const KanbanCardDepSchema = z.object({
  cardId: z.int(),
  dependsOnCardId: z.int(),
  depType: z.string(),
});

export type KanbanCardDep = z.infer<typeof KanbanCardDepSchema>;
