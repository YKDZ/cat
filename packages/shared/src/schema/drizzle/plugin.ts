...
export const PluginServiceSchema = z.object({
  ...
  serviceId: z.string(),
  pluginInstallationId: z.int(),
  serviceType: z.enum(["AUTH_PROVIDER", "MFA_PROVIDER", "STORAGE_PROVIDER", "TERM_EXTRACTOR", "TERM_ALIGNER", "FILE_IMPORTER", "FILE_EXPORTER", "TRANSLATION_ADVISOR", "TEXT_VECTORIZER", "VECTOR_STORAGE", "QA_CHECKER", "TOKENIZER", "LLM_PROVIDER", "AGENT_TOOL_PROVIDER", "AGENT_CONTEXT_PROVIDER"]),
  createdAt: DrizzleDateTimeSchema,
  updatedAt: DrizzleDateTimeSchema,
});
