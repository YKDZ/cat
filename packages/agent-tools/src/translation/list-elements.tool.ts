...
export const listElementsTool: AgentToolDefinition = {
  name: "list_elements",
  description:
    "List translatable elements in the current editor scope with pagination. Supports project-wide browsing and subtree filters. Returns element ID, source text, translation status, primary content-node metadata, and sort index.",
  ...
  async execute(args, ctx) {
    ...
    const requestedContentNodeIds = parsed.contentNodeIds;
