...
CREATE TABLE "PermissionTemplate" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "PermissionTemplate_content_resource_type_unique" UNIQUE("content","resource_type")
);
--> statement-breakpoint
CREATE TABLE "Plugin" (
	"id" text PRIMARY KEY,
...
CREATE TABLE "Role" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "Role_name_scope_type_scope_id_unique" UNIQUE("name","scope_type","scope_id")
);
--> statement-breakpoint
...
CREATE TABLE "TranslatableElementCommentReaction" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "TranslatableElementCommentReaction_translatable_element_comment_id_user_id_unique" UNIQUE("translatable_element_comment_id","user_id")
);
--> statement-breakpoint
...
CREATE TABLE "TranslatableString" (
	...
	"language_id" text NOT NULL,
	"chunk_set_id" integer NOT NULL,
	CONSTRAINT "TranslatableString_language_id_value_unique" UNIQUE("language_id","value")
);
--> statement-breakpoint
...
CREATE INDEX "element_id_idx" ON "TranslatableElementCommentReaction" ("translatable_element_comment_id");--> statement-breakpoint
...
ALTER TABLE "MemoryItem" ADD CONSTRAINT "MemoryItem_source_string_id_TranslatableString_id_fkey" FOREIGN KEY ("source_string_id") REFERENCES "TranslatableString"("id") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "TranslatableElementComment" ADD CONSTRAINT "TranslatableElementComment_rVcH2vk2wZwM_fkey" FOREIGN KEY ("parent_comment_id") REFERENCES "TranslatableElementComment"("id") ON DELETE SET NULL ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "TranslatableElementComment" ADD CONSTRAINT "TranslatableElementComment_csrAMZXJDU4O_fkey" FOREIGN KEY ("root_comment_id") REFERENCES "TranslatableElementComment"("id") ON DELETE SET NULL ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "TranslatableElementCommentReaction" ADD CONSTRAINT "TranslatableElementCommentReaction_KPjwkNbfQ9zz_fkey" FOREIGN KEY ("translatable_element_comment_id") REFERENCES "TranslatableElementComment"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "TranslatableElementCommentReaction" ADD CONSTRAINT "TranslatableElementCommentReaction_user_id_User_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "UserRole" ADD CONSTRAINT "UserRole_user_id_User_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "UserRole" ADD CONSTRAINT "UserRole_role_id_Role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "Role"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "Vector" ADD CONSTRAINT "Vector_chunk_id_Chunk_id_fkey" FOREIGN KEY ("chunk_id") REFERENCES "Chunk"("id") ON DELETE CASCADE ON UPDATE CASCADE;