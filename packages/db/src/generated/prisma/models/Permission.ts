...
export type PermissionWhereUniqueInput = Prisma.AtLeast<{
  permission_userId?: Prisma.PermissionPermissionUserIdCompoundUniqueInput
  AND?: Prisma.PermissionWhereInput | Prisma.PermissionWhereInput[]
  OR?: Prisma.PermissionWhereInput[]
  NOT?: Prisma.PermissionWhereInput | Prisma.PermissionWhereInput[]
  permission?: Prisma.StringFilter<"Permission"> | string
...
export type PermissionPermissionUserIdCompoundUniqueInput = {
  permission: string
  userId: string
}
...
export type PermissionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"permission" | "userId", ExtArgs["result"]["permission"]>
...
export interface PermissionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const permissionWithPermissionOnly = await prisma.permission.findMany({ select: { permission: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Permissions and only return the `permission`
   * const permissionWithPermissionOnly = await prisma.permission.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Permissions and only return the `permission`
   * const permissionWithPermissionOnly = await prisma.permission.updateManyAndReturn({
   *   select: { permission: true },
   *   where: {
   *     // ... provide filter here
   *   },
