...
- The index is generated by `pnpm nx run autodoc:generate` and committed to the repo.
- If lookup returns no results, the index may be stale — regenerate with `pnpm nx run autodoc:generate`.
